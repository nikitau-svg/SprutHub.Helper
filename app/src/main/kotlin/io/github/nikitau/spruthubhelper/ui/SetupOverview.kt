...
internal enum class SettingsSection(
    ...
    GUIDE(
        title = "Как управлять",
        description = "Рабочий стол, шторка, панель и совместимость телефона",
    ),
    DIAGNOSTICS(
...
internal fun buildHomeReadiness(
    ...
    return HomeReadiness(
        ...
        detail = if (configured.isEmpty()) {
            "Каталог актуален. Теперь можно добавлять управление на рабочий стол, в шторку или панель устройств."
        } else {
